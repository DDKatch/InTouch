...
CREATE TABLE `user_subs` (
  ...
  KEY `fk_subs_idx` (`subscriber`),
  CONSTRAINT `fk_subs` FOREIGN KEY (`subscriber`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_user222` FOREIGN KEY (`user`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2016-04-14 19:52:29
