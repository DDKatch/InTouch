 ...
 * @author vladislav
 */
public class GetUserFollowersProcessor extends Processor{
    ...
    public JSONObject processRequest(Map<String, String[]> params) throws ServerQueryException {
        ...
        jSONObject.put("users", new Gson().toJson(DataHelper.getInstance().getUserFollowers(Long.parseLong(params.get("user_id")[0]), "user")));
        return jSONObject;
    }
